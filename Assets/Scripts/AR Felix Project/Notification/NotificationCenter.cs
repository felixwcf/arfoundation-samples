...
using System;
/* Felix Aug 2020: Usage https://wiki.unity3d.com/index.php/NotificationCenter
 * 
 * NotificationCenter
...
NotificationCenter.js allows for easy and powerful messaging between objects in Unity. An object can register as an observer and receive notifications of a certain type when they occur. When that notification type is posted elsewhere, all objects that registered as an observer for that notification type will receive a message that it has occurred, along with the associated data.
...
Javascript - NotificationCenter.js
